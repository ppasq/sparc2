...
geodash.handlers.printMap = function($scope, $interpolate, $http, $q, event, args) {
  ...
  var size = /** @type {ol.Size} */ (geodash.var.map.getSize());
  var extent = geodash.var.map.getView().calculateExtent(size);
  ...
  map.getView().fit(extent, /** @type {ol.Size} */ (geodash.var.map.getSize()));
  map.renderSync();
